...
# base_url = "http://ec2-52-14-183-157.us-east-2.compute.amazonaws.com" #"ec2-52-14-183-157.us-east-2.compute.amazonaws.com" #"ec2-54-237-153-115.compute-1.amazonaws.com"
...
def get_all_tweets(screen_name):
	...
	while len(new_tweets) > 0:
		...
		if overall_count >= 600 or len(new_tweets) < 200:
			...
			filename = "tweets_max" + str(oldest) + ".json"
